...
import com.mytech.thebagsservice.exceptions.UserNotFoundException;
...
public class ForgotPasswordController {
	...
	private void sendEmail(String link, String email) throws UnsupportedEncodingException, MessagingException {
		...
		try {
			...
			emailService.sendMessageUsingThymeleafTemplate("update2yourmail@gmail.com", subject, templateModel);
		} catch (IOException e) {
			e.printStackTrace();
	...
	public String processResetForm(@RequestParam(name = "token") String token,
	...
	public String processChangeForm(@RequestParam(name = "id") int id, @RequestParam(name = "password") String password,
			Model model) {
