...
import com.mytech.thebagsportal.exporters.UserCsvExporter;
import com.mytech.thebagsportal.exporters.UserExcelExporter;
import com.mytech.thebagsportal.exporters.UserPdfExporter;
import com.mytech.thebagsportal.helpers.AppConstant;
import com.mytech.thebagsportal.helpers.AppHelper;
import com.mytech.thebagsportal.mailer.EmailService;
import com.mytech.thebagsportal.storage.StorageService;
...
import com.mytech.thebagsservice.paging.PagingAndSortingHelper;
import com.mytech.thebagsservice.paging.PagingAndSortingParam;
...
public class UserController {
	...
	public String saveUser(@RequestParam("avatar") MultipartFile file, User user, RedirectAttributes redirectAttributes) {
		...
		// emailService.sendSimpleMessage("update2yourmail@gmail.com", "User added",
		...
		try {
			...
			emailService.sendMessageUsingThymeleafTemplate("update2yourmail@gmail.com", "User info", templateModel);
		} catch (IOException e) {
			e.printStackTrace();
